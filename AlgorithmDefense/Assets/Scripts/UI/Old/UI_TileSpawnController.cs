...
public class UI_TileSpawnController : MonoBehaviour
{
    ...
    public void CreateButton(RectTransform container, Button btn_Obj, BuildButtonsInformation[] btn_Slot)
    {
        ...
        for (int i = 0; i < btn_Slot.Length; i++)
        {
            ...
            //생성된 버튼의 좌표와 이미지 변경
            newButton.transform.localPosition = new Vector3(newButton.transform.localPosition.x + 207.5f * i, newButton.transform.localPosition.y, newButton.transform.localPosition.z);
